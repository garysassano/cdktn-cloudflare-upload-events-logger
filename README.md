# cdktn-cloudflare-upload-events-logger

CDKTN app that generates a log upon uploading a file to an R2 bucket.

### Related Apps

- [wrangler-cloudflare-upload-events-logger](https://github.com/garysassano/wrangler-cloudflare-upload-events-logger) - Built with Wrangler instead of CDKTN.
